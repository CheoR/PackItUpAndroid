 ...
 *
 * @param viewModel The [CollectionsScreenViewModel] used to manage the data and state. Defaults to a ViewModel provided by the [PackItUpViewModelProvider].Factory.
+ * @see Screen
